...
tcs3200 tcs(9, 8, 11, 10, 12); // Pin configuration: (S0, S1, S2, S3, output pin)
...
void motorstopper() {
  digitalWrite(IN1, LOW);  // Stop motor by setting IN1 to LOW
  digitalWrite(IN2, LOW);  // Stop motor by setting IN2 to LOW
}
